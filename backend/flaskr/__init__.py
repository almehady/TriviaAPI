...
def create_app(test_config=None):
  ...
  def get_categories():
    ...
    formated_cats = [cat.format() for cat in cats]

    return jsonify({
      'success': True,
      'cats': formated_cats[start:end],
      'total cats': len(formated_cats)

    })

  @app.route('/categories/<int:category_id>')
  def get_specific_cat(category_id):
  ...
  def create_question():
    ...
    try:
      if search:
        ...
        question = Question(question=new_question, answer=new_answer, new_difficulty=new_difficulty, new_category=new_category)
        question.insert()
